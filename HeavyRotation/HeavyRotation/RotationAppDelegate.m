...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [nc addObserver:self selector:@selector(changeBackGroundProximity:) name:UIDeviceProximityStateDidChangeNotification object: device];
...
- (void)changeBackGroundProximity:(NSNotification *)note
{
    NSLog(@"In changeBackGround");
