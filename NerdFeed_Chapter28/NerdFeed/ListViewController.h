...
@interface ListViewController : UITableViewController<NSURLConnectionDelegate, NSURLConnectionDataDelegate, NSXMLParserDelegate, UITextFieldDelegate>
{
    UITextField *songField;
    RSSChannel *channel;
