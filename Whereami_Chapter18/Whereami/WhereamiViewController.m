...
NSString * const WhereamiLongtitudePrefKey = @"WhereamiLongtitudePrefKey";
...
+ (void)initialize
{
    ...
    NSArray *values = [NSArray arrayWithObjects:[NSNumber numberWithInt:1], [NSNumber numberWithDouble:10.4], [NSNumber numberWithDouble:106.4], nil];
    NSArray *keys = [NSArray arrayWithObjects:WhereamiMapTypePrefKey, WhereamiLatitudePrefKey, WhereamiLongtitudePrefKey,nil];
...
- (void)viewDidLoad
{
    ...
    CLLocationDegrees longtitude = [[NSUserDefaults standardUserDefaults] doubleForKey:WhereamiLongtitudePrefKey];
...
- (void)foundLocation:(CLLocation *)loc
{
    ...
    [[NSUserDefaults standardUserDefaults] setDouble:coord.longitude forKey:WhereamiLongtitudePrefKey];
