...
- (void)encodeWithCoder:(NSCoder *)aCoder
{
    ...
    [aCoder encodeObject:subForum forKey:@"subForum"];
...
- (id)initWithCoder:(NSCoder *)aDecoder
{
    ...
    if (self) {
        ...
        [self setSubForum:[aDecoder decodeObjectForKey:@"subForum"]];
...
- (NSDictionary *)writeToJSONDictionary: (NSString *)path
{
    ...
    [entry setObject:[NSDictionary dictionaryWithObject:[self title] forKey:@"label"] forKey:@"title"];
    
    
    
    NSMutableDictionary *info = [[NSMutableDictionary alloc] init];
    [info setObject:[NSDictionary dictionaryWithObject:[self link] forKey:@"href"] forKey:@"attributes"];
    
    
    NSMutableArray *slink = [[NSMutableArray alloc] init];
    [slink addObject:@"None"];
    [slink addObject:info];
    [entry setObject:slink forKey:@"link"];
